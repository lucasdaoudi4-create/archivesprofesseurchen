        ...
        <div className="wrap">
          ...
          <div className="notice mt-[var(--sp-8)]" data-rv>
            <div className="notice__g pilier-email">
              ...
              <div className="hero__b">
                {/* `liens.module01` vise `/formation#sommaire`, pas la route
                    `/formation/module-01` : celle-ci est renvoyée sur `/formation`
                    par `App.tsx` ET par `netlify.toml`. Viser la destination réelle
